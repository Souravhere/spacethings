...
const categories = [
  ...
  {
    title: <span className='font-sans'>POS</span>,
    icon: FaCashRegister,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          {categories.map((category, index) => (
            <motion.div
              key={index}
              className="bg-white p-6 rounded-lg shadow-lg border border-blue-200 hover:scale-105 hover:shadow-2xl transform transition-transform"
